...
:experimental:
:url-github: https://github.com/hyperpolymath/well-known-ecosystem
:url-gitlab: https://gitlab.com/hyperpolymath/well-known-ecosystem
:url-bitbucket: https://bitbucket.org/hyperpolymath/well-known-ecosystem
:url-codeberg: https://codeberg.org/hyperpolymath/well-known-ecosystem

Well-known URI ecosystem management
...
well-known-ecosystem is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
